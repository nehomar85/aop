...
//comentarear if si viene por ajax	
	...
	$sqlBasico = "SELECT * FROM casos WHERE ";
	...
	$sqlFinal = $sqlBasico . $sqlIdcaso . $sqlEstatus . $sqlPrioridad . $sqlCliente . $sqlUsuario . $sqlProducto . $sqlRango ." medio != '' ORDER BY idCaso DESC";
