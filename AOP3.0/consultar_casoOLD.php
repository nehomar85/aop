...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<form id="frmSearch" method="post" action="consultar_caso">
	<!--form id="frmSearch"-->
	  <!-- SELECT -->
      <div class="container-fluid">
		<div class="row">
				  ...
				  <div class="row">
					...
					<div class="col-md-3">
					  ...
					  <div class="form-group">
						...
						<button id="Search" type="submit" class="btn btn-success" value="Search">Buscar</button>
      ...
      <!-- /.box -->
	  <input type="hidden" name="MM_update" value="frmSearch" />
	</form>
	<div class="container-fluid">
	  <div class="row">
		<div class="col-md-12">
		  <div class="card card-primary">
			...
			<div class="card-body"><?php include('tablas/rsl_consulta_caso.php');?></div>
